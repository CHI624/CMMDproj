...
$host = "localhost";
$db   = "form_submissions_quer_research";
$user = "root";
$pass = "Dabonem123!";
...
$QUER_AUDIO = $_POST['QUER_AUDIO'] ?? '';


// ── Single INSERT with the three list‑columns
$sql = "
  INSERT INTO form_submissions_quer1
    (RESEARCHER_N, JOB, JOB_DESCR, QUER_IMAGE, QUER_AUDIO QUER_AUDIO MAIN_HAZ, DESCR_MAIN, HAZ_LOC)
  VALUES
    (?, ?, ?, ?, ?, ?, ?, ?)
";
...
header("Location: ARMOR_QUER_INPUT_RESEARCHER.php");
exit;
?>
